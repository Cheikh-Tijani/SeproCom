...
if (empty($reshook))
{
    ...
    && ($action == 'add' || $action == 'update') && $user->rights->societe->creer)
    {
        ...
        $object->typepiece             = GETPOST('typepiece', 'alpha');
        $object->numeropiece           = GETPOST('numeropiece', 'alpha');
...
else
{
    ...
    if ($action == 'create')
    {
        ...
        print '</td>';
        print '</tr>';
        // Ajout du type de piece et numero
        print '<tr><td>'.fieldLabel('Type Piece','typepiece').'</td>';
        print '<td>';
        $statutarray = array('' => '','Passeport' => 'Passeport', 'Carte d\'identite' => 'Carte d\'identite');
        print $form->selectarray('typepiece',$statutarray,GETPOST('typepiece'));
        print  '</td>';
        print '<td>'.fieldLabel('Numero piece','numeropiece').'</td>';
        print '<td><input type="text" name="numeropiece" id="numeropiece" value="'.$object->numeropiece.'"></td></tr>';
    ...
    elseif ($action == 'edit')
    {
        ...
        if ($socid)
        {
            ...
            print '<td>';
            $statutarray = array('' => '','Passeport' => 'Passeport', 'Carte d\'identite' => 'Carte d\'identite');
            print $form->selectarray('typepiece',$statutarray,$object->typepiece);
            print  '</td>';
            print '<td>'.fieldLabel('Numero piece','numeropiece').'</td>';
            print '<td><input type="text" name="numeropiece" id="numeropiece" value="'.$object->numeropiece.'"></td></tr>';
    ...
    else
    {
        ...
        // Ajout du type de piece et numero
        print '<tr><td>'.fieldLabel('Type Piece','typepiece').'</td><td>'.$object->typepiece.'</td></tr>';
        print'<tr><td>'.fieldLabel('Numero piece','numeropiece').'</td><td>'.$object->numeropiece.'</td></tr>';
