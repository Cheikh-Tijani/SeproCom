...
class Propal extends CommonObject
{
    ...
    function create($user, $notrigger=0)
    {
        ...
        $sql.= ", '".$this->db->escape($this->zone1)."'";
        $sql.= ", '".$this->db->escape($this->zone2)."'";
        $sql.= ", '".$this->db->escape($this->zone3)."'";
        $sql.= ", '".$this->db->escape($this->zone4)."'";
        $sql.= ", '".$this->db->escape($this->budgetminimal)."'";
        $sql.= ", '".$this->db->escape($this->budgetmaximal)."'";
    ...
    function fetch($rowid,$ref='')
    {
        ...
        $sql.= ", p.zone1 as zone1, p.zone2 as zone2, p.zone3 as zone3, p.zone4 as zone4, p.budgetminimal as budgetminimal, p.budgetmaximal as budgetmaximal";
        ...
        if ($resql)
        {
            if ($this->db->num_rows($resql))
            {
                ...
                $this->zone2                = $obj->zone2;
                $this->zone3                = $obj->zone3;
                $this->zone4                = $obj->zone4;
                $this->budgetminimal        = $obj->budgetminimal;
                $this->budgetmaximal        = $obj->budgetmaximal;
