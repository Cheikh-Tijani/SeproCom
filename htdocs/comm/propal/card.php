		...
		if (! $error)
		{
			...
			if (GETPOST('createmode') == 'copy' && GETPOST('copie_propal'))
			{
				if ($object->fetch(GETPOST('copie_propal')) > 0) {
					...
					$object->zone1 = GETPOST('zone1');
					$object->zone2 = GETPOST('zone2');
					$object->zone3 = GETPOST('zone3');
					$object->zone4 = GETPOST('zone4');
                    $object->budgetminimal = GETPOST('budgetminimal');
                    $object->budgetmaximal = GETPOST('budgetmaximal');
...
if ($action == 'create')
{
    ...
    // Public Zone1
    print '<tr><td>'.$langs->trans("Zone1").'</td><td>';
    print $form->select_zone(GETPOST('zone1','int'),'zone1');
    print '</td></tr>';

    // Public Zone2
    print '<tr><td>'.$langs->trans("Zone2").'</td><td>';
    print $form->select_zone(GETPOST('zone2','int'),'zone2');
    print '</td></tr>';

    // Public Zone3
    print '<tr><td>'.$langs->trans("Zone3").'</td><td>';
    print $form->select_zone(GETPOST('zone3','int'),'zone3');
    print '</td></tr>';

    // Public Zone4
    print '<tr><td>'.$langs->trans("Zone4").'</td><td>';
    print $form->select_zone(GETPOST('zone4','int'),'zone4');
    print '</td></tr>';

    // Public Budget minimal
    print '<tr><td>'.$langs->trans("Budget Minimal").'</td><td>';
    print '<input type="text" name="budgetminimal" value="'.GETPOST('budgetminimal').'">';
    print '</td></tr>';

    // Public Budget maximal
    print '<tr><td>'.$langs->trans("Budget Maximal").'</td><td>';
    print '<input type="text" name="budgetmaximal" value="'.GETPOST('budgetmaximal').'">';
    print '</td></tr>';
    ...
    // Public Zone1
    print '<tr><td>'.$langs->trans("Zone1").'</td><td>'.$form->convertRowIdtoLibelle($object->zone1, 'libelle', 'c_zone').'</td></tr>';

    // Public Zone2
    print '<tr><td>'.$langs->trans("Zone2").'</td><td>'.$form->convertRowIdtoLibelle($object->zone2, 'libelle', 'c_zone').'</td></tr>';

    // Public Zone3
    print '<tr><td>'.$langs->trans("Zone3").'</td><td>'.$form->convertRowIdtoLibelle($object->zone3, 'libelle', 'c_zone').'</td></tr>';

    // Public Zone4
    print '<tr><td>'.$langs->trans("Zone4").'</td><td>'.$form->convertRowIdtoLibelle($object->zone4, 'libelle', 'c_zone').'</td></tr>';

    // Public Budget Minimal
    print '<tr><td>'.$langs->trans("Budget Minimal").'</td><td>'.$object->budgetminimal.'</td></tr>';

    // Public Budget Maximum
    print '<tr><td>'.$langs->trans("Budget Maximal").'</td><td>'.$object->budgetmaximal.'</td></tr>';
