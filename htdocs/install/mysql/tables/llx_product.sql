...
(
  ...
  tom     				double(6,3),           -- model save dodument used
  tlv     				double(6,3),           -- model save dodument used
  zone			    	varchar(255),           -- model save dodument used
  ascenseur				varchar(255),           -- model save dodument used
  proprietaire				int,           -- model save dodument used
  numeroappartement				varchar(255),           -- model save dodument used
  niveauetage				varchar(255),           -- model save dodument used
  groupeelectrogene				varchar(255),           -- model save dodument used
  orientation				varchar(255),           -- model save dodument used
