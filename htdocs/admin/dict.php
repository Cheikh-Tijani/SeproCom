...
$taborder=array(35,36,37,38,39,40,9,0,4,3,2,0,1,8,19,16,27,0,5,11,33,34,0,6,0,29,0,7,17,24,28,0,10,23,12,13,0,14,0,22,20,18,21,0,15,30,0,25,0,26,0,31,32,0);
...
//Nouvel table dictionnaire CTN
$tabname[35]= MAIN_DB_PREFIX."c_tom";
$tabname[36]= MAIN_DB_PREFIX."c_tlv";
$tabname[37]= MAIN_DB_PREFIX."c_zone";
$tabname[38]= MAIN_DB_PREFIX."c_etage";
$tabname[39]= MAIN_DB_PREFIX."c_orientation";
$tabname[40] = MAIN_DB_PREFIX."c_typeproduit";
//Fin Nouvel table dictionnaire CTN
...
//Nouvel table dictionnaire CTN
$tablib[35]= "DictionaryTOM";
$tablib[36]= "DictionaryTLV";
$tablib[37]= "DictionaryZone";
$tablib[38]= "DictionaryEtage";
$tablib[39]= "DictionaryOrientation";
$tablib[40]= "DictionaryTypeproduit";
//Fin Nouvel table dictionnaire CTN
...
$tabsql[35]= "SELECT t.rowid, t.code, t.taux, c.label as country, c.code as country_code, t.fk_pays as country_id, t.recuperableonly, t.note, t.active, t.accountancy_code_sell, t.accountancy_code_buy FROM ".MAIN_DB_PREFIX."c_tom as t, ".MAIN_DB_PREFIX."c_country as c WHERE t.fk_pays=c.rowid";
$tabsql[36]= "SELECT t.rowid, t.code, t.taux, c.label as country, c.code as country_code, t.fk_pays as country_id, t.recuperableonly, t.note, t.active, t.accountancy_code_sell, t.accountancy_code_buy FROM ".MAIN_DB_PREFIX."c_tlv as t, ".MAIN_DB_PREFIX."c_country as c WHERE t.fk_pays=c.rowid";
$tabsql[37] = "SELECT f.rowid as rowid, f.code, f.libelle, c.code as country_code, c.label as country, f.active FROM ".MAIN_DB_PREFIX."c_zone as f, ".MAIN_DB_PREFIX."c_country as c WHERE f.fk_pays=c.rowid";
$tabsql[38] = "SELECT f.rowid as rowid, f.code, f.libelle, c.code as country_code, c.label as country, f.active FROM ".MAIN_DB_PREFIX."c_etage as f, ".MAIN_DB_PREFIX."c_country as c WHERE f.fk_pays=c.rowid";
$tabsql[39] = "SELECT f.rowid as rowid, f.code, f.libelle, c.code as country_code, c.label as country, f.active FROM ".MAIN_DB_PREFIX."c_orientation as f, ".MAIN_DB_PREFIX."c_country as c WHERE f.fk_pays=c.rowid";
$tabsql[40] = "SELECT f.rowid as rowid, f.code, f.libelle, c.code as country_code, c.label as country, f.active FROM ".MAIN_DB_PREFIX."c_typeproduit as f, ".MAIN_DB_PREFIX."c_country as c WHERE f.fk_pays=c.rowid";
...
//Nouvel table dictionnaire CTN
$tabsqlsort[35]="country ASC, code ASC, taux ASC, recuperableonly ASC";
$tabsqlsort[36]="country ASC, code ASC, taux ASC, recuperableonly ASC";
$tabsqlsort[37] ="country ASC, code ASC, libelle ASC";
$tabsqlsort[38] ="country ASC, code ASC, libelle ASC";
$tabsqlsort[39] ="country ASC, code ASC, libelle ASC";
$tabsqlsort[40] ="country ASC, code ASC, libelle ASC";
//Fin Nouvel table dictionnaire CTN
...
//ctn
$tabfield[35]= "country_id,country,code,taux,recuperableonly,accountancy_code_sell,accountancy_code_buy,note";
$tabfield[36]= "country_id,country,code,taux,recuperableonly,accountancy_code_sell,accountancy_code_buy,note";
$tabfield[37] = "code,libelle,country";
$tabfield[38] = "code,libelle,country";
$tabfield[39] = "code,libelle,country";
$tabfield[40] = "code,libelle,country";
//ctn
...
//CTN
$tabfieldvalue[35]= "country,code,taux,recuperableonly,accountancy_code_sell,accountancy_code_buy,note";
$tabfieldvalue[36]= "country,code,taux,recuperableonly,accountancy_code_sell,accountancy_code_buy,note";
$tabfieldvalue[37] = "code,libelle,country";
$tabfieldvalue[38] = "code,libelle,country";
$tabfieldvalue[39] = "code,libelle,country";
$tabfieldvalue[40] = "code,libelle,country";
//CTN
...
//CTN
$tabfieldinsert[35]= "fk_pays,code,taux,recuperableonly,accountancy_code_sell,accountancy_code_buy,note";
$tabfieldinsert[36]= "fk_pays,code,taux,recuperableonly,accountancy_code_sell,accountancy_code_buy,note";
$tabfieldinsert[37] = "code,libelle,fk_pays";
$tabfieldinsert[38] = "code,libelle,fk_pays";
$tabfieldinsert[39] = "code,libelle,fk_pays";
$tabfieldinsert[40] = "code,libelle,fk_pays";
//CTN
...
$tabcond[35]= true;
$tabcond[36]= true;
$tabcond[37] = (! empty($conf->societe->enabled));
$tabcond[38] = (! empty($conf->societe->enabled));
$tabcond[39] = (! empty($conf->societe->enabled));
...
//CTN
$tabhelp[35] = array('code'=>$langs->trans("EnterAnyCode"), 'taux'=>$langs->trans("Taxe sur les ordures ménagères"), 'recuperableonly'=>$langs->trans(""));
$tabhelp[36] = array('code'=>$langs->trans("EnterAnyCode"), 'taux'=>$langs->trans("Taxe sur les logements vacants"), 'recuperableonly'=>$langs->trans(""));
...
if (GETPOST('actionadd') || GETPOST('actionmodify'))
{
    ...
    {
        if ($value == 'country_id' && in_array($tablib[$id],array('DictionaryVAT','DictionaryTLV','DictionaryTOM','DictionaryRegion','DictionaryCompanyType','DictionaryHolidayTypes','DictionaryRevenueStamp','DictionaryAccountancysystem','DictionaryAccountancyCategory'))) continue;		// For some pages, country is not mandatory
